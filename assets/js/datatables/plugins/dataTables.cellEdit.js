    ...
    updateEditableCell: function(callingElement) {
      ...
      function _addValidationCss() {
        ...
        if (settings.onValidate) {
          settings.onValidate(cell, row, newValue);
        }
      }
  ...
  switch (inputType) {
    case "list":
      input.html =
        ...
        "<select class='" +
        inputCss +
        "' onchange='$(this).updateEditableCell(this);'>";
    ...
    case "list-confirm": // List w/ confirm
      ...
      input.html =
        input.html +
        "</select>&nbsp;<a href='javascript:void(0);' class='" +
        confirmCss +
        "' onclick='$(this).updateEditableCell(this);'>" +
        Translator.trans("common.confirm") +
        "</a> <a href='javascript:void(0);' class='" +
        cancelCss +
        "' onclick='$(this).cancelEditableCell(this)'>" +
    ...
    case "datepicker-confirm":
      ...
      input.html =
        startWrapperHtml +
        "<input id='ejbeatycelledit' type='text' name='date' class='datepick " +
        inputCss +
        "'   value='" +
        oldValue +
        "'></input> &nbsp;<a href='javascript:void(0);' class='" +
        confirmCss +
        "' onclick='$(this).updateEditableCell(this)'>" +
        Translator.trans("common.confirm") +
        "</a> <a href='javascript:void(0);' class='" +
    ...
    case "text-confirm": // text input w/ confirm
      input.html =
        startWrapperHtml +
        "<input id='ejbeatycelledit' class='" +
        inputCss +
        "' value='" +
        oldValue +
        "'" +
        (listenToKeys
          ? " onkeyup='if(event.keyCode==13) {$(this).updateEditableCell(this);} else if (event.keyCode===27) {$(this).cancelEditableCell(this);}'"
          : "") +
        "></input>&nbsp;<a href='javascript:void(0);' class='" +
        confirmCss +
        "' onclick='$(this).updateEditableCell(this)'>" +
    ...
    case "textarea-confirm":
      input.html =
        startWrapperHtml +
        "<textarea id='ejbeatycelledit' class='" +
        inputCss +
        "'>" +
        oldValue +
        "</textarea><a href='javascript:void(0);' class='" +
        confirmCss +
        "' onclick='$(this).updateEditableCell(this)'>" +
        Translator.trans("common.confirm") +
        "</a> <a href='javascript:void(0);' class='" +
    ...
    case "number-confirm":
      input.html =
        startWrapperHtml +
        "<input id='ejbeatycelledit' type='number' class='" +
        inputCss +
        "' value='" +
        oldValue +
        "'" +
    ...
    default:
      ...
      input.html =
        ...
        "<input id='ejbeatycelledit' class='" +
        inputCss +
        "' onfocusout='$(this).updateEditableCell(this)' value='" +
        oldValue +
        "'></input>" +
        endWrapperHtml;
      break;
